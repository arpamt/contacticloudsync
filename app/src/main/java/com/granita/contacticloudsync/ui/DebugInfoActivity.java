    ...
    static class ReportLoader extends AsyncTaskLoader<String> {
        ...
        public String loadInBackground() {
            ...
            try {
                ...
                try {
                    workaroundInstalled = pm.getPackageInfo("com.granita.contacticloudsync.jbworkaround", 0) != null;
                } catch(PackageManager.NameNotFoundException e) {}
                report.append(
                        "SOFTWARE INFORMATION\n" +
                                "version: " + BuildConfig.VERSION_NAME + " (" + BuildConfig.VERSION_CODE + ") " + BuildConfig.buildTime.toString() + "\n" +
