...
import com.granita.contacticloudsync.log.StringLogger;
import com.granita.contacticloudsync.resource.DavResourceFinder;
import com.granita.contacticloudsync.resource.LocalTaskList;
...
public class QueryServerDialogFragment extends DialogFragment implements LoaderCallbacks<ServerInfo> {
    ...
    static class ServerInfoLoader extends AsyncTaskLoader<ServerInfo> {
        private static final String TAG = "ServerInfoLoader";
        final Bundle args;
