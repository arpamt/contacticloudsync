...
import com.granita.contacticloudsync.resource.Event;
import com.granita.contacticloudsync.webdav.DavProp.Comp;
...
public class WebDavResource {
	private static final String TAG = "contacticloudsync.WebDavResource";
	...
	public void multiGet(DavMultiget.Type type, String[] names) throws URISyntaxException, IOException, DavException, HttpException {
		...
		for (int i = context.getRequestConfig().getMaxRedirects(); i > 0; i--) {
			...
			for (String name : names)
				...
				// contacticloudsync ensures that collections always have a trailing slash, so "./" won't go down in directory hierarchy
