...
public class AccountSettings {
	private final static String TAG = "contacticloudsync.AccountSettings";
    ...
    //custom start
    public void setAddressBookURL(String URL){
        accountManager.setUserData(account,KEY_ADDRESSBOOK_URL, URL);
    }
    //custom end
	...
	private void update(int fromVersion, int toVersion) {
		...
		try {
			...
			Log.e(TAG, "Couldn't update account settings (contacticloudsync will probably crash)!", e);
		}
	}
