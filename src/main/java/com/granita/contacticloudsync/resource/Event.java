...
import com.granita.contacticloudsync.syncadapter.DavSyncAdapter;
...
public class Event extends Resource {
	private final static String TAG = "contacticloudsync.Event";
	...
	public ByteArrayOutputStream toEntity() throws IOException {
		...
		ical.getProperties().add(new ProdId("-//bitfire web engineering//contacticloudsync " + Constants.APP_VERSION + " (ical4j 1.0.x)//EN"));
